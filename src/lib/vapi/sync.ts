...
export const MEERKAT_VOICE_DISTRIBUTION: Record<string, string[]> = {
  ...
  nia:   ['crear_lead', 'agendar_cita', 'registrar_pedido', 'buscar_cliente', 'notificar_transferencia', 'transferir_llamada', 'registrar_encuesta', 'buscar_documento_oficina', 'consultar_agente', 'delegar_tarea', 'reportar_falla', 'marcar_no_llamar', 'agregar_tag_contacto'],
