...
export const MEERKAT_VOICE_DISTRIBUTION: Record<string, string[]> = {
  ...
  naia:  ['agendar_cita', 'buscar_cliente', 'registrar_encuesta', 'enviar_correo', 'crear_documento', 'list_calendar_events', 'create_calendar_event', 'delete_calendar_event', 'buscar_archivo', 'leer_archivo', 'reportar_falla'],
