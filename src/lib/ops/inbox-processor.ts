...
export const MEERKAT_EMAIL_DISTRIBUTION: Record<string, string[]> = {
  ...
  neus:  ['create_file', 'create_document', 'save_to_drive', 'buscar_archivo', 'leer_archivo', 'buscar_correo_enviado', 'buscar_documento_oficina', 'enviar_documento_oficina', 'extraer_voz_del_cliente', 'search_leads', 'delegar_tarea', 'consultar_agente', 'pedir_a_humano'],
