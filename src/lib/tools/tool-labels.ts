...
export const TOOL_LABELS: Record<string, string> = {
  ...
  pedir_datos_faltantes:        'Pedir datos faltantes al cliente',
  reportar_bug_a_nash:          'Reportar bug del sistema a Nash',
  registrar_pago_pendiente_verificacion: 'Registrar comprobante SPEI (auto-approve o pending)',
