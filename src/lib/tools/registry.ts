...
export const TOOL_REGISTRY: ToolEntry[] = [
  ...
  { name: 'firmar_oc',                description: 'Evalúa reglas de autofirma y aplica firma digitalizada sobre PDF (1 op)', channels: ['chat', 'email'], category: 'ciclo_oc_cfdi', destructive: true,  gatedByRole: ['nox', 'nala'], gatedByFeature: 'quickbooks', capability: null, policy: DEFAULT_POLICY },
  ...
  { name: 'qb_crear_cotizacion',      description: 'Nox: crea cotización (Estimate) en QuickBooks para un cliente (destructivo, 1 op)',            channels: ['chat', 'email'], category: 'quickbooks', destructive: true, gatedByRole: ['nox'], gatedByFeature: 'quickbooks', capability: null, policy: DEFAULT_POLICY },
