...
const TOOL_REGISTRY_BASE: Omit<ToolEntry, 'pack'>[] = [
  ...
  { name: 'consultar_fichas', description: 'Nia/Nara: consulta las fichas informativas del negocio (trámites municipales, productos, servicios, procedimientos internos, etc.). Modo dual (stuffed catálogo completo o embeddings semántico según config del org). Devuelve fichas + contacto humano sugerido para cascada.', channels: A, category: 'knowledge', destructive: false, gatedByRole: ['nia', 'nara'], gatedByFeature: 'fichas_informativas', capability: null, policy: DEFAULT_POLICY },
