...
const TOOL_REGISTRY_BASE: Omit<ToolEntry, 'pack'>[] = [
  ...
  // fiscal internos Centinelia (Neka) — timbra a nombre de Centinelia hacia sus clientes via Facturama
  { name: 'emitir_cfdi_centinelia',   description: 'Emite CFDI Ingreso a nombre de Centinelia (Neka interna, Facturama)', channels: A, category: 'fiscal', destructive: true,  gatedByRole: ['neka'], gatedByFeature: null, capability: null, policy: DEFAULT_POLICY },
  { name: 'solicitar_complemento_pago', description: 'Emite Complemento de Pago (REP) para un CFDI PPD ya timbrado (Neka interna, Facturama)', channels: A, category: 'fiscal', destructive: true,  gatedByRole: ['neka'], gatedByFeature: null, capability: null, policy: DEFAULT_POLICY },
  { name: 'pedir_datos_faltantes',    description: 'Marca que el correo requiere más datos del cliente para poder timbrar. Neka redacta la respuesta pidiéndolos.', channels: A, category: 'fiscal', destructive: false, gatedByRole: ['neka'], gatedByFeature: null, capability: null, policy: DEFAULT_POLICY },
  { name: 'reportar_bug_a_nash',      description: 'Reporta un bug/limitación del sistema a Nash (crea platform_incident). Úsala cuando el problema NO es del cliente sino del código Centinelia.', channels: A, category: 'fiscal', destructive: false, gatedByRole: ['neka'], gatedByFeature: null, capability: null, policy: DEFAULT_POLICY },
  { name: 'registrar_pago_pendiente_verificacion', description: 'Recibe comprobante SPEI del cliente. Evalúa reglas de auto-aprobación (UUID válido + cliente activo + monto exacto + no dedupe). Si todas cumplen, timbra REP inmediato. Si algo falla, guarda pending + notifica a Nazre.', channels: A, category: 'fiscal', destructive: true, gatedByRole: ['neka'], gatedByFeature: null, capability: null, policy: DEFAULT_POLICY },
  ...
  { name: 'consultar_fichas', description: 'Todos los meerkats client-facing: consulta las fichas informativas del negocio (trámites, productos, servicios, procedimientos internos, etc.). Modo dual stuffed/embeddings según config del org. Feature flag por org es la barrera; el rol no restringe.', channels: A, category: 'knowledge', destructive: false, gatedByRole: null, gatedByFeature: 'fichas_informativas', capability: null, policy: DEFAULT_POLICY },
  // pack perfiles_vivos — memoria persistente por contacto (deudor, prospecto, paciente, cuenta)
  { name: 'consultar_contacto',          description: 'Consulta perfil vivo + últimas 5 interacciones al inicio de la conversación. Da continuidad histórica.', channels: A, category: 'memory', destructive: false, gatedByRole: null, gatedByFeature: 'perfiles_vivos', capability: null, policy: DEFAULT_POLICY },
  { name: 'registrar_interaccion',       description: 'Al final de la conversación, guarda resumen + sentimiento + promesa + próxima acción. Actualiza contadores del perfil.',       channels: A, category: 'memory', destructive: false, gatedByRole: null, gatedByFeature: 'perfiles_vivos', capability: null, policy: DEFAULT_POLICY },
  { name: 'actualizar_contacto_estado',  description: 'Cambia estado_actual, próxima acción, capacidad de pago detectada, notas. Confirma promesa cumplida.',                        channels: A, category: 'memory', destructive: false, gatedByRole: null, gatedByFeature: 'perfiles_vivos', capability: null, policy: DEFAULT_POLICY },
  ...
  { name: 'escalar_al_owner',              description: 'Nash: email a INTERNAL_ALERT_EMAIL (default hola@centinelia.mx) marcando incidente como assigned_to=owner',              channels: ['chat', 'email'], category: 'nash', destructive: true,  gatedByRole: ['nash'], gatedByFeature: null,                       capability: null, policy: DEFAULT_POLICY },
  ...
  // 2 tools exclusivas de navi_agencia para gestion multi-cuenta.
  { name: 'canva_listar_plantillas',         description: 'Lista plantillas de Canva disponibles para la cuenta del negocio',                           channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'canva_generar_diseno',            description: 'Genera un diseno en Canva usando una plantilla de la marca con campos variables',             channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'canva_exportar',                  description: 'Exporta un diseno de Canva a PNG, JPG o MP4 y devuelve URL de descarga',                     channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'generar_caption',                 description: 'Genera el caption para un post segun tema, tono y tipo de publicacion',                       channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'generar_hashtags',                description: 'Genera lista de hashtags relevantes (alto volumen + nicho) para un post',                     channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'crear_borrador_post',             description: 'Crea borrador de post para Instagram (draft hasta programar o publicar)',                      channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'programar_publicacion',           description: 'Programa la publicacion de un borrador en fecha y hora indicadas',                            channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'publicar_ahora',                  description: 'Publica de inmediato un borrador de post en Instagram (destructivo)',                          channels: A, category: 'social', destructive: true,  gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'ig_responder_comentario',         description: 'Responde a un comentario de Instagram en nombre del negocio (destructivo)',                    channels: A, category: 'social', destructive: true,  gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'ig_responder_dm',                 description: 'Responde a un DM de Instagram en nombre del negocio (destructivo)',                           channels: A, category: 'social', destructive: true,  gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'consultar_metricas_post',         description: 'Consulta metricas de un post de Instagram (impresiones, alcance, likes, etc.)',                channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'proponer_calendario_editorial',   description: 'Propone calendario editorial semanal o mensual con temas y horarios optimos',                  channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'listar_media_del_cliente',        description: 'Lista archivos de medios de la biblioteca del negocio para usar en posts',                     channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
  { name: 'usar_media_del_cliente',          description: 'Selecciona archivo de medios de la biblioteca del negocio para un post o diseno',              channels: A, category: 'social', destructive: false, gatedByRole: ['navi', 'navi_agencia'], gatedByFeature: 'social_publishing', capability: null, policy: DEFAULT_POLICY },
