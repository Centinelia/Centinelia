  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Los minutos y tareas no usados acumulan al mes siguiente hasta un maximo del doble de tu tier (cap 2x). Si tienes 250 min en Media Jornada Combinada y solo usas 100, el siguiente mes empiezas con 400 min (250 incluidos + 150 acumulados). Al llegar al tope, los excedentes se pierden — el portal te avisa por correo cuando esto ocurre.',
      },
      {
