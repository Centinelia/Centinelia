...
import DemoAgentEditor from '../demo/DemoAgentEditor';
  ...
  if (!agentId) {
    return (
      <div className="p-8 max-w-lg">
        <h1 className="text-xl font-bold mb-3" style={{ color: '#1A0A3B' }}>Demo personalizado</h1>
        <div className="rounded-xl p-5" style={{ background: 'rgba(245,158,11,0.08)', border: '1px solid rgba(245,158,11,0.25)' }}>
          ...
          <p className="text-sm" style={{ color: '#4A3B6B' }}>
            Agrega la variable de entorno <code className="px-1 rounded" style={{ background: '#FFFFFF', fontFamily: 'monospace' }}>DEMO_PERSONALIZADO_AGENT_ID</code> con el UUID del agente demo de Monterrey en Supabase.
          </p>
