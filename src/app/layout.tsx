...
const softwareSchema = {
  ...
  offers: [
    ...
    { '@type': 'Offer', name: 'Empleado Centinelia — Media Jornada', price: '2997', priceCurrency: 'MXN', description: '250 minutos/mes, 320 tareas de oficina, empleado digital activo 24/7. Instalacion unica $14,990 MXN.' },
