...
const softwareSchema = {
  ...
  offers: [
    ...
    { '@type': 'Offer', name: 'Empleado Centinelia — Media Jornada', price: '2997', priceCurrency: 'MXN', description: '250 minutos/mes, 300 tareas de oficina, empleado digital activo 24/7. Instalacion unica $14,990 MXN.' },
    { '@type': 'Offer', name: 'Empleado Centinelia — Jornada Completa', price: '5994', priceCurrency: 'MXN', description: '500 minutos/mes, 600 tareas de oficina, empleado digital activo 24/7. Plan mas popular.' },
    { '@type': 'Offer', name: 'Empleado Centinelia — Alta Demanda', price: '11988', priceCurrency: 'MXN', description: '1,000 minutos/mes, 1,200 tareas de oficina, para operaciones de alto volumen.' },
  ],
  featureList: [
