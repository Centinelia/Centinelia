...
export const metadata: Metadata = {
  ...
  description: 'Agente de voz con IA que agenda citas, responde preguntas y captura nuevos pacientes 24/7. Sin perder una sola llamada. Desde $2,997/mes.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Agente de voz con IA que agenda citas, responde preguntas y captura nuevos pacientes 24/7. Desde $2,997/mes.',
