...
export const metadata: Metadata = {
  ...
  description: 'Agente de voz con IA que califica leads, agenda consultas y atiende llamadas 24/7 para despachos de abogados, contadores y agencias. Plan Comercial desde $2,997/mes.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Agente de voz con IA que califica leads, agenda consultas y atiende llamadas 24/7. Plan Comercial desde $2,997/mes.',
