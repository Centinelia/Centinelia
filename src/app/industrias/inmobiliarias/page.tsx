...
export const metadata: Metadata = {
  ...
  description: 'Agente de voz con IA que atiende prospectos, filtra por presupuesto y agenda visitas a propiedades 24/7. No pierdas otro comprador. Desde $2,997/mes.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Agente de voz con IA que atiende prospectos, filtra por presupuesto y agenda visitas 24/7. Desde $2,997/mes.',
