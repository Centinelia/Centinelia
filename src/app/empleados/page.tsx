...
const CONTENT: Record<string, {
  ...
  nia: {
    rolLabel: 'Seguimiento Ciudadano Digital',
  ...
  noah: {
    rolLabel: 'Operaciones Digitales',
  ...
  nelia: {
    rolLabel: 'Atención al Cliente Digital',
  ...
  nara: {
    rolLabel: 'Administración Digital',
  ...
  naia: {
    rolLabel: 'Recursos Humanos Digital',
  ...
  nova: {
    rolLabel: 'Centro de Coordinación Digital',
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8" style={{ zIndex: 1 }}>
          <div className="flex flex-col lg:flex-row items-end gap-0">
            ...
            {/* Group photo — desktop */}
            <div className="hidden lg:block relative flex-shrink-0" style={{ width: 560, height: 460 }}>
              <Image
          ...
          {/* Group photo — mobile */}
          <div className="lg:hidden relative w-full" style={{ height: 260, marginTop: -32, marginBottom: 0 }}>
            <Image
              src="/meerkats/grupo.png"
              alt="Equipo Centinelia"
              fill
