  ...
  return (
    <div style={{ background: C.bg, color: C.text, minHeight: '100vh' }}>
      ...
      <header style={{ borderBottom: `1px solid ${C.border}`, background: C.bg }}>
        <div className="max-w-4xl mx-auto px-5 sm:px-8" style={{ height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <main className="max-w-4xl mx-auto px-5 sm:px-8" style={{ paddingTop: 56, paddingBottom: 80 }}>
        ...
        {/* Índice */}
        <nav style={{ marginTop: 28, display: 'flex', flexWrap: 'wrap', gap: 8 }}>
          {[
