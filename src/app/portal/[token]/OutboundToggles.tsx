...
export default function OutboundToggles({ token, initOutbound, initMissedCallRecovery }: Props) {
  ...
  const rows: {
  ...
  }[] = [
    {
      ...
      desc:  'Permite que el agente realice llamadas a tus contactos de forma manual o automática.',
      value: outbound,
    ...
    },
    {
      ...
      desc:  'Si un cliente llama y el agente no puede contestar, el agente lo llama de regreso automáticamente para disculparse y atenderle.',
      value: missed,
